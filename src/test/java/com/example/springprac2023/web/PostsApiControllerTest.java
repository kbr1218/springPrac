...
// Api controller를 테스트하는데 @WebMvcTest를 사용하지 않음
// @WebMvcTest의 경우 JPA 기능이 작동하지 않기 떄문
// Contoller와 ControllerAdvice 등 외부 연동과 관련된 부분만 활성화되니
// JPA 기능까지 한번에 테스트할 때는 @SpringBootTest와 TestRestTemplate을 사용하면 됨
